...
<h4 class="header">Auction rules</h4>
    ...
    <tbody>
        ...
        <c:forEach var="auctionRule" items="${gridItems}" varStatus="loopCounter">
            <tr>
                ...
                <td class="right"><a class="btn-floating" href="${pagesAuctionRule}/${auctionRule.id}"><i class="material-icons">info</i></a> <a
                    class="btn-floating" href="${pagesAuctionRule}/${auctionRule.id}/edit"><i class="material-icons">edit</i></a> <a
                    class="btn-floating red" href="${pagesAuctionRule}/${auctionRule.id}/delete"><i class="material-icons">delete</i></a></td>
            </tr>
        </c:forEach>
    </tbody>
</table>
