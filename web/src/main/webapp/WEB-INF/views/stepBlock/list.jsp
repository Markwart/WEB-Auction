    ...
    <tbody>
        ...
        <c:forEach var="stepBlock" items="${gridItems}" varStatus="loopCounter">
            <tr>
                ...
                <td class="right"><a class="btn-floating" href="${pagesStepBlock}/${stepBlock.id}"><i class="material-icons">info</i></a> <a
                    class="btn-floating" href="${pagesStepBlock}/${stepBlock.id}/edit"><i class="material-icons">edit</i></a> <a
                    class="btn-floating red" href="${pagesStepBlock}/${stepBlock.id}/delete"><i class="material-icons">delete</i></a></td>
            </tr>
        </c:forEach>
    </tbody>
</table>
