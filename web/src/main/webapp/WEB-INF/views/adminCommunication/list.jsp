    ...
    <tbody>
        ...
        <c:forEach var="adminCommunication" items="${gridItems}" varStatus="loopCounter">
            <tr>
                ...
                <td class="right"><a class="btn-floating color-icon" href="${pagesAdminCommunication}/${adminCommunication.id}"><i class="material-icons">pageview</i></a>
                
                <sec:authorize access="hasRole('admin')">
                <a class="btn-floating color-icon" href="${pagesAdminCommunication}/${adminCommunication.id}/edit"><i class="material-icons">edit</i></a> 
                <a class="btn-floating color-icon-delete" href="${pagesAdminCommunication}/${adminCommunication.id}/delete"><i class="material-icons">delete_forever</i></a>
                </sec:authorize></td>
            </tr>
        </c:forEach>
    </tbody>
