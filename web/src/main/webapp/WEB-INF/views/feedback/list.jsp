    ...
    <tbody>
        ...
        <c:forEach var="feedback" items="${gridItems}" varStatus="loopCounter">
            <tr class="font">
                ...
                <td class="right"><a class="btn-floating" href="${pagesFeedback}/${feedback.id}"><i class="material-icons">info</i></a> <a
                    class="btn-floating" href="${pagesFeedback}/${feedback.id}/edit"><i class="material-icons">edit</i></a> <a
                    class="btn-floating red" href="${pagesFeedback}/${feedback.id}/delete"><i class="material-icons">delete</i></a></td>
            </tr>
        </c:forEach>
    </tbody>
</table>
