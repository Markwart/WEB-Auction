...
public class AdminCommunicationController2 extends AbstractController {
	...
	@Autowired
	private AdminCommunicationController2(IAdminCommunicationService adminCommunicationService,
			AdminCommunicationToDTOConverter toDtoConverter, AdminCommunicationFromDTOConverter fromDtoConverter) {
		super();
